...
BEGIN
	INSERT INTO Assignment(AssignmentName, AssignmentDescription, AssignmentDate, PersonId, StatusId) VALUES ('Walk the Dog', 'Take the dog for a brisk walk', '2026-12-15 06:00:00.000', 1, 1)
END
GO
...
BEGIN
	INSERT INTO Assignment(AssignmentName, AssignmentDescription, AssignmentDate, PersonId, StatusId) VALUES ('Grocery Shopping', 'Compile a list of necessary groceries and head to the nearest supermarket or grocery store.', '2026-12-28 19:00:00.000', 2, 1)
END
GO
...
BEGIN
	INSERT INTO Assignment(AssignmentName, AssignmentDescription, AssignmentDate, PersonId, StatusId) VALUES ('Pay Bills', 'Set aside time to review and pay outstanding bills.', '2026-12-25 20:30:00.000', 3, 3)
END
GO
